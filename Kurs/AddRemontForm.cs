...
namespace Kurs
{
    public partial class AddRemontForm : Form
    {
        ...
        private void AddRemontForm_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                using (var command = new SqlCommand("P18", connection))
                {
                    try
                    {
                        ...
                        command.Parameters.Add(new SqlParameter("@ДатаНач", daten_.Value));
                        command.Parameters.Add(new SqlParameter("@ДатаКон", datek_.Value));
                        command.Parameters.Add(new SqlParameter("@ФиоРемонтирующего", fio_.Text));
